...
export default function PartyLedger() {
  ...
  return (
    <>
      ...
      />
      <PageBreadcrumb pageTitle={`Currency Ledger ${party ? '- ' + 'Name: ' + party.name + ', Phone: ' + party.phoneCode + party.phoneNumber : ''}`} />
          ...
          <div className="max-w-full mx-4">
            ...
            <Table>
              <TableHeader className="border border-gray-500 dark:border-white/[0.05] bg-gray-200 text-black text-sm dark:bg-gray-800 dark:text-gray-400">
                <TableRow>
                  <TableCell colSpan={5} isHeader className="border border-gray-500 text-center px-4 py-2">{' '}</TableCell>
              ...
              <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
               {status === 'loading' ? (
                ...
                <TableRow>
                  <TableCell colSpan={5} isHeader className="border border-gray-500 text-center px-4 py-1">Total:</TableCell>
                ...
                <TableRow>
                  <TableCell colSpan={5} isHeader className="border border-gray-500 text-center px-4 py-1">Balance:</TableCell>
                ...
                <TableRow>
                  <TableCell colSpan={5} isHeader className="border border-gray-500 text-center px-4 py-1">Close Balance:</TableCell>
