...
import { CountryOptions, StatusOptions } from "../../types.ts";
...
export default function BusinessEditForm() {
    ...
    useEffect(() => {
      console.log("User found:", business);
            ...
            <div>
              ...
              <img
                src={formData.businessLogo instanceof File
                  ...
                  ? `http://localhost:5000/api${formData.businessLogo}`
            ...
            <div>
              ...
              <img
                src={formData.businessLicenseCopy instanceof File
                  ...
                  ? `http://localhost:5000/api${formData.businessLicenseCopy}`
                  : "http://localhost:5173/public/images/logo/logo-icon.svg"
                }
                alt="Preview"
                className="mt-2 w-20 h-20"
