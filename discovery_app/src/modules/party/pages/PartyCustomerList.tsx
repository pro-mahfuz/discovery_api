...
export default function PartyCustomerList() {
  const navigate = useNavigate();
  const dispatch = useDispatch<AppDispatch>();

  const parties = useSelector(selectAllCustomers);
            ...
            <Table>
              <TableHeader className="border-b border-t border-gray-100 dark:border-white/[0.05] bg-gray-200 text-black text-sm dark:bg-gray-800 dark:text-gray-400">
                <TableRow>
                  ...
                  <TableCell isHeader className="text-center px-4 py-2">Customer/Company Name</TableCell>
